...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Large Dent Repair', item: 'https://dent-boyz.com/services/large-dent-repair' },
  ],
};
      ...
      <section className="py-16 px-4 bg-light-gray">
        <div className="container-xl max-w-2xl">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">Tell us about the damage and we&apos;ll respond within 1 business day.</p>
          </div>
